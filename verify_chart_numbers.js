...
console.log('Calculating statistics for 2025 (Jan-Oct)...');
...
console.log(`\n--- Market Overview (Jan-Oct 2025) ---`);
console.log(`Total Seats: ${totalSeats.toLocaleString()} (${(totalSeats / 10000).toFixed(1)} 萬)`);
console.log(`Total Passengers: ${totalPassengers.toLocaleString()} (${(totalPassengers / 10000).toFixed(1)} 萬)`);

console.log(`\n--- Top Destinations (Jan-Oct 2025) ---`);
